    ...
    <ScrollView>
      <View style={{ flexDirection:"row", alignItems:"center",marginTop:40, marginHorizontal:20 }}>
            ...
            <View style={{flexDirection:"row", alignItems:"center", alignSelf:"center" }}>
                ...
                <Text style={{ paddingHorizontal:10, fontWeight:"bold", fontSize:16 }}>Observar ahora</Text>
                </View>
            </View>
         ...
         <Image source={require('../images/5.png')} style={{ height:300, width:300, alignSelf:"center" }}/>
            <View
             style={{
                 flexDirection:"row",
                 alignSelf:"center",
